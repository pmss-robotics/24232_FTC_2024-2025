...
public class FeedForwardArmSubsystem extends SubsystemBase {
    ...
    private DcMotorEx shoulder1, shoulder2, elbow;
    ...
    public double ks_Cos = 0.000, ks_A = 0; // ks_S, ks_V?
    //elbow
    public static double eP = 0.000, eI = 0.000, eD = 0.000;
    public double ke_Cos = 0.000, ke_A = 0; //

    public static double shoulderTicksPerRev = 2786.2, elbowTicksPerRev = 0;
    ...
    public double shoulderTarget, elbowTarget; //change to int after getting positions in degrees
    ...
    public FeedForwardArmSubsystem(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        shoulderTarget = shoulder1.getCurrentPosition();
    ...
    private double shoulderCalculate() {
        ...
        power += ks_Cos * Math.cos(angle) + ks_A;
